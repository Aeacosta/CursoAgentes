...
plantilla = open(r"Ejemplos/Plantilla.md").read()

Pregunta = "Cuales code smells identificas? ->" + archivo + "De recomendaciones y citas basado en el Clean Code de Rober C Martin que tienes como prompt" + "Utiliza la siguiente plantilla para la respuesta: " + plantilla
